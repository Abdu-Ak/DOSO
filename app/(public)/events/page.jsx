...
export const metadata = {
  ...
  description: "Stay updated with the latest events, religious seminars, and announcements from Darul Hidaya Dars.",
};
...
export default function EventsPage() {
  return (
    <>
      ...
      <main className="grow z-10 py-12 px-4 sm:px-6 lg:px-8 relative">
