...
export default async function Leadership() {
  ...
  const leaders = [
    {
      role: leadership?.president?.title || "President",
    ...
    {
      role: leadership?.secretary?.title || "Secretary",
    ...
    {
      role: leadership?.treasurer?.title || "Treasurer",
      data: leadership?.treasurer,
      desc: "Ensuring financial stability and transparent management of institutional resources",
      color: "bg-success/10",
    ...
    <section className="py-20 bg-white dark:bg-surface-dark" id="leadership">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {leaders
            .filter((leader) => leader.data?.name)
            .map((leader, index) => (
              <div
                key={index}
              ...
              >
                <div className="flex flex-col sm:flex-row h-full">
                  ...
                  <div className="sm:w-3/5 p-6 flex flex-col justify-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-300 text-sm font-body mb-4 line-clamp-4">
                      {leader.desc}
                    </p>
