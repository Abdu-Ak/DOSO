...
import { User, LogOut, ChevronDown, Edit2, UserPen } from "lucide-react";
...
const UserTopbar = ({ menus = [] }) => {
  ...
  const portalTitle = role === "student" ? "Student Portal" : "DOSO Portal";
        ...
        <Dropdown placement="bottom-end">
          ...
          >
            ...
            <DropdownItem
              ...
              onPress={() => router.push(`/${role}/profile/edit`)}
              className="font-bold"
            >
              Edit Profile
            </DropdownItem>
