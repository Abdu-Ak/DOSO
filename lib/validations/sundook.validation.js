...
export const publicCreateSundookSchema = z.object({
  alumni: z.string().min(1, "Alumni selection is required"),
  box_number: z.coerce.number().int().min(1, "Box number is required"),
